...
- 🌱 Right now I'm practicing Angular.js for web dev, Python for backend and Figma for mock-ups. I'm making a quote generator using Python, Angular.js and postgreSQL. Recently I finished a web store that I made using Next.js, React Redux, TypeScript and Firebase.
...
- In the future I'd like to do at least space invaders and tetris games in JavaScript, a project management site with advanced tools and an app for work team coordination and scheduling.
