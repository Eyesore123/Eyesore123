...
- 🌱 Right now I'm making a blog app that I intend to host on my Raspberry Pi and and then fetch blogs to showcase on my portfolio site. Before my blog app project I made a quote generator using Python, Angular.js and postgreSQL. And recently I finished a web store that I made using Next.js, React Redux, TypeScript and Firebase.
